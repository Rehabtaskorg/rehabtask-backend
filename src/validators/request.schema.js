...
export const createRequestSchema = z.object({
    ...
    rate: z.number({ coerce: true }).positive("Rate must be a positive number").max(9999.99, "Rate cannot exceed $9,999.99"),
...
export const updateRequestSchema = z.object({
    ...
    rate: z.number({ coerce: true }).positive("Rate must be a positive number").max(9999.99, "Rate cannot exceed $9,999.99").optional(),
    visitType: z.string().trim().min(1).max(100).optional().nullable(),
    visitTypeId: z.string().uuid().optional().nullable(),
